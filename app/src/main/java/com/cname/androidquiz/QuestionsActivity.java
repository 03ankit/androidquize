...
public class QuestionsActivity extends AppCompatActivity {
    ...
    String answers[] = {"main method","Mobile device","this","interface","public","import pkg.*","None of the mentioned","java","equals()","Dalvik virtual machine","Google"};
    String opt[] = {
            "finalize method","main method","static method","private method",
            "Servers","Desktops","Laptops","Mobile device",
